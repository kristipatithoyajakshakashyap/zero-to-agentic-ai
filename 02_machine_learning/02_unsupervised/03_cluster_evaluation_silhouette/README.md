...
⚠️ Still pair it with the elbow/business constraints - silhouette favors
...
├── 01_theory_and_mathematics.nb.py      <- compute s(i) BY HAND for 5 iris flowers
├── 02_model_development_workflow.nb.py  <- elbow+silhouette combo, diagrams k=5/k=2
├── 01_easy_mall_ksweep.nb.py            <- PROJECT: sweep k, diagram k=3/5/7
