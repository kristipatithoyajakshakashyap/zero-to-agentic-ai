...
$$\text{gain} = \underbrace{\tfrac12\frac{G_L^2}{H_L+\lambda}}_{left}
+\underbrace{\tfrac12\frac{G_R^2}{H_R+\lambda}}_{right}
-\underbrace{\tfrac12\frac{(G_L+G_R)^2}{H_L+H_R+\lambda}}_{parent}
-\gamma$$
...
⚠️ **Version churn alert**: in xgboost ≥ 1.6 (and all of 3.x),
...
## Contents
- `01_theory_and_mathematics.nb.py` - one split's gain priced BY HAND, λ sweep, NaN-routing autopsy
