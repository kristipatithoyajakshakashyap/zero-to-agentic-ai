# Track 03 - Agentic AI (LangChain Fundamentals)
...
| Folder | Step | Teaches |
|---|---|---|
| `01_chat_models_providers` | 1 | Ollama (local-first) · Groq · HuggingFace · OpenAI swap pattern |
| `02_prompt_templates` | 2 | ChatPromptTemplate, roles, variables, few-shot |
| `03_output_parsers_pydantic` | 3 | Typed trustworthy output (parsers pt 1) |
| `04_lcel_and_runnables` | 4 | Pipe syntax, passthrough/assign/parallel, streaming (parsers pt 2) |
| `05_document_loaders` | 5 | txt · md · csv · json · pdf · web · directory loaders |
| `06_chunking_strategies` | 6 | character · recursive · token · markdown-aware · code-aware |
| `07_embeddings` | 7 | Free local embedders vs OpenAI (separate notebooks) |
| `08_vector_stores` | 8 | Chroma and FAISS side-by-side, head-to-head comparison |
| `09_retrievers` | 9 | as_retriever, similarity vs MMR, k/fetch_k |
| `10_basic_rag` | 10 | Minimal retrieval-augmented generation chain |
| `11_memory_and_state` | 11 | Session-id history, RunnableWithMessageHistory |
| `12_capstone_rag_chatbot` | 12-13 | Everything combined into a document-chat application |
