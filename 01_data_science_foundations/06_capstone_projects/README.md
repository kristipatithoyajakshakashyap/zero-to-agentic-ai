...
Project 05 auto-downloads the IMDB corpus once and caches it one level up, at
`01_data_science_foundations/data/imdb_reviews.csv` (i.e. `../data/` relative to
this folder). It is already there if someone has run the notebook before you.
